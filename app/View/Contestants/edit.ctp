...
<?php echo $this->Form->create('Contestant'); ?>
	<fieldset>
		<legend><?php echo __('Edit Contestant'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Contestant.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Contestant.id'))); ?></li>
