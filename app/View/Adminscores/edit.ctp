...
<?php echo $this->Form->create('Adminscore'); ?>
	<fieldset>
		<legend><?php echo __('Edit Adminscore'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Adminscore.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Adminscore.id'))); ?></li>
